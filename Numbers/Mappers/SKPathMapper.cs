namespace Numbers.Mappers
{
    ...
    {
        public PositionDomain PolylineDomain => (PositionDomain)MathElement;
        ...
        public SKPathMapper(MouseAgent agent, SKSegment guideline = null) : base(agent, new PositionDomain(500, 500), guideline)
        {
            Pen = Pens.DrawPen;
        }
